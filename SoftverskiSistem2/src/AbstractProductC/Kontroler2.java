...
public final class Kontroler2 extends Kontroler{
    ...
    public Kontroler2(Forma ef1,BrokerBazePodataka bbp1){ef=ef1;bbp=bbp1; Povezi(); osveziFormu();}
    ...
    {javax.swing.JButton Kreiraj = (javax.swing.JButton) ef.getPanel().getKreiraj();
     ...
     Nadji.addActionListener((e)->{napuniDomenskiObjekatIzGrafickogObjekta();
         nadjiDomenskiObjekat();});
     
     javax.swing.JTextField SifraPrijave = (javax.swing.JTextField) ef.getPanel().getSifraPrijave1(); // Promenljivo!!!
